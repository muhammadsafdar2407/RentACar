...
function Table() {
  ...
  const handleDelete = async (id) => {
    try {
      const res = await axiosInstance.delete(`/post/deletepost/${id}`);
      console.log(res);
      getPosts();
        ...
        <div className="px-4 md:px-10 py-4 md:py-7 bg-gray-100 rounded-xl dark:bg-gray-900">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm sm:text-base leading-normal text-gray-600 dark:text-gray-400 dark:text-gray-500">
                Number of Vehicle listings: {listings.length}
              </p>
            </div>
            <div>
