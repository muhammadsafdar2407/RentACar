      ...
      <footer className="bg-white dark:bg-dark-main border-t dark:border-t-gray-800 text-gray-800 ">
        <div className="xl:max-w-[1200px] max-w-[90%] py-10 px-4 lg:pt-20 mx-auto">
          ...
          <div className="mt-5 sm:mt-12 grid gap-y-2 sm:gap-y-0 sm:flex sm:justify-between sm:items-center">
            ...
            <div>
              <div className="inline-flex justify-center items-center gap-x-3.5 w-10 h-10 text-center text-accent-1 hover:bg-white/[.1] rounded-md focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 focus:ring-offset-gray-900 transition">
                <svg
                  className="w-4 h-4"
